...
export function Spinner({ 
  ...
  return (
    <>
      ...
      <div className={`flex flex-col items-center justify-center gap-6 font-serif ${className}`}>
        
        {/* The Spinner Container */}
        <div className={`relative ${sizeClasses[size]} flex items-center justify-center drop-shadow-md wagon-spinner`}>
          ...
          <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <g stroke="#5C4533" strokeWidth={4.5} strokeLinecap="round">
              ...
              <line x1="50" y1="14" x2="50" y2="86" transform="rotate(30 50 50)" />
              <line x1="50" y1="14" x2="50" y2="86" transform="rotate(60 50 50)" />
              <line x1="50" y1="14" x2="50" y2="86" transform="rotate(90 50 50)" />
              <line x1="50" y1="14" x2="50" y2="86" transform="rotate(120 50 50)" />
              <line x1="50" y1="14" x2="50" y2="86" transform="rotate(150 50 50)" />
            </g>

            {/* 2. Wooden Felloes (Thick wooden part of the rim) */}
            <circle cx="50" cy="50" r="40" fill="none" stroke="#5C4533" strokeWidth={7}/>

            {/* 3. Outer Iron Tire */}
            <circle cx="50" cy="50" r="43.5" fill="none" stroke="#2C2724" strokeWidth={2}/>

            {/* 4. Inner Iron Band */}
            <circle cx="50" cy="50" r="36.5" fill="none" stroke="#2C2724" strokeWidth={1} opacity={0.8}/>

            {/* 5. The Hub */}
            <circle cx="50" cy="50" r="14" fill="#5C4533" stroke="#2C2724" strokeWidth={2}/>
            <circle cx="50" cy="50" r="9" fill="none" stroke="#3A2A20" strokeWidth={1}/>
