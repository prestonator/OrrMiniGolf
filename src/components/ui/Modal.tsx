...
export function Modal({
  ...
  return (
    <div
      className={`relative w-full bg-cream p-1 shadow-2xl overflow-hidden ${className}`}
    >
      {badgeText && (
      ...
      <div className="border border-dark-blue/60 p-[3px] h-full w-full">
        <div
          className={`border border-dark-blue/60 p-6 sm:p-8 bg-cream flex flex-col ${innerClassName}`}
        >
          {children}
        </div>
      </div>
