  ...
  return (
    ...
    >
      <div className="z-10 flex flex-col items-center max-w-md w-full mt-8">
        {/* Modal Container */}
        <div className="relative w-full bg-cream p-1 shadow-2xl">
                ...
                <>
                  ...
                  <div className="flex flex-col gap-4">
                    <button
                      ...
                      className="w-full bg-light-blue hover:bg-light-blue/90 disabled:bg-dark-blue/40 text-cream font-bold text-xl py-4 px-4 rounded shadow-lg shadow-light-blue/30 transition-all active:translate-y-1 uppercase tracking-wide flex justify-center items-center"
                    >
                      {isProcessing ? (
                    ...
                    <button
                      onClick={() => navigate("/")}
                      disabled={isProcessing}
                      className="w-full bg-transparent hover:bg-dark-blue/5 text-dark-blue font-bold text-lg py-3 px-4 rounded border-2 border-dark-blue transition-all disabled:opacity-50"
                    >
                      Cancel
                    </button>
                  </div>
